...
<body class="flex flex-col min-h-screen">
    ...
    <main class="flex-grow flex items-center justify-center p-4">
        <div class="bg-white p-6 md:p-8 rounded-xl shadow-lg w-full max-w-md">
            ...
            <p class="text-gray-600 mb-6">Have an account? <a href="login.html" class="text-blue-600 hover:underline">Login Here!</a></p>
            ...
            <form class="space-y-4">
                ...
                //kena add direction to database untuk add acc user 
